...
for(var i = 0; i < message.guild.members.size; i++) {
   if(message.guild.members.array()[i].hasPermission("ADMINISTRATOR") && message.guild.members.array()[i].presence.status === "dnd" && !message.guild.members.array()[i].user.bot) {
      str += `<:dnd:665220721860935680> ${message.guild.members.array()[i].user.tag}\n`
    }
      ...
      str += `<:online:665220459117150208> ${message.guild.members.array()[i].user.tag}\n`
    }
      ...
      str += `<:idle:665220232847163404> ${message.guild.members.array()[i].user.tag}\n`
    }
      ...
      str += `<:invisible:665219891690995733> ${message.guild.members.array()[i].user.tag}\n`
    }
}
