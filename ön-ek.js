...
module.exports.run = async (client, message, args) => {
  ...
  if (arg === "r?") return message.reply("Botun orjinal ön ekini özel ön ek olarak ayarlayamazsın! \nEğer ön ekin botun normal ön eki olmasını istiyorsan `a!` yerine `varsayılan` yazarak ön-ek komutunu kullan!")
  ...
  if (arg === "varsayılan") {
    ...
    .setDescription("Ön-Ek sıfırlanıp `a!` olarak ayarlanmıştır!")
